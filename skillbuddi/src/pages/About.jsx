        ...
        <div className="text-section">
          ...
          <div className="text-and-logos">
            ...
            <p className="text">
              ...
              skills, learn from one another, and grow as a community. Whether
              you want to teach coding, learn a new language, or improve your
              painting skills, we make it easy to connect with others who share
              your passions.
            </p>
